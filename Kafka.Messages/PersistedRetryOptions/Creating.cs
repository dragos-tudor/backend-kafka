...
{
  public static PersistedRetryOptions CreatePersistedRetryOptions(
  ...
  public static PersistedRetryOptions CreatePersistedRetryOptionsFromEnvironment(
    ...
    string maxRetryDelayMillisecondsName = "KAFKA_MAX_RETRY_DELAY_MS")
  {
    ...
    return CreatePersistedRetryOptions(
      maxRetryAttempts,
      retryBaseDelay,
      retryBackoffFactor,
      maxRetryDelay);
