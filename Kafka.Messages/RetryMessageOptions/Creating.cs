...
{
  public static RetryMessageOptions CreateRetryMessageOptions(
  ...
  public static RetryMessageOptions CreateRetryMessageOptionsFromEnvironment(
    ...
    string maxRetryDelayMillisecondsName = "KAFKA_MAX_RETRY_DELAY_MS")
  {
    ...
    return CreateRetryMessageOptions(
      maxRetryAttempts,
      retryBaseDelay,
      retryBackoffFactor,
      maxRetryDelay);
