...
partial class InboxFuncs
{
    ...
    IInstrumentationServices services)
  {
    ...
    AddMetricCounter(services.GetMetricCounters<InboxCounterType>(), InsertedCounter);
    ...
    IInstrumentationServices services)
  {
    ...
    AddMetricCounter(services.GetMetricCounters<InboxCounterType>(), InsertErrorCounter);
